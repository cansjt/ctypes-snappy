# -*- coding: utf-8; -*-
from ctypes import byref, cdll, create_string_buffer, c_char_p, c_int, util

__all__ = ['compress', 'uncompress', 'decompress']

try:
    lib_snappy_path = util.find_library('snappy')
    lib_snappy = cdll.LoadLibrary(lib_snappy_path)
